...
class AuthService {
  ...
  private initializeRoutes(): void {
    const authController = new AuthenticationController(this.dbService, this.redisService);
    const sessionController = new SessionController(this.dbService, this.redisService);
  ...
  public start(): void {
    ...
    this.app.listen(port, host, () => {
      ...
      this.logger.info(`API documentation available at http://${host}:${port}/api`);
    });
  }
